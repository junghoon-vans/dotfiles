...
| `brew-packages` | Installs common `Brewfile` dependencies, including Homebrew-managed `mise`, `chezmoi`, `hermes-agent`, and the `claude-code` cask, and performs brew-owned post-install steps. |
