...
| `codex` | Installs Codex CLI, bootstraps LazyCodex configuration, configures file-backed MCP OAuth storage, and ensures Atlassian MCP is registered. |
