...
2. `brew-packages` - install common `Brewfile` packages, including `mise`, `chezmoi`, Hermes Agent CLI bootstrap, and the Claude Code CLI cask, and perform brew-owned post-install steps
